...
The inactive warning uses a deep-red danger treatment with bold white text so it is clearly distinguished from normal information notices.
...
- Form validation uses readable inline errors instead of browser-native format popups
